...
";
        ...
        // id=""table-container""
        string TableHeader = @"<table class=""table-fill""><thead><tr><th width=""150px"" height=""80px"">Krok</th><th>Výraz</th><th width=""32%""> Popis následující úpravy</th><th>Izolovaná úprava</th></tr></thead><tbody class=""tableBody""> ";
